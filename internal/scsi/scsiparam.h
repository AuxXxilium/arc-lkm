/**
 * This file contains a list of cherry-picked constants useful while dealing
 * with SCSI subsystem
 */
...
#define SCSI_CMD_TIMEOUT                                                       \
  (30 * HZ) // originally defined in drivers/scsi/sd.h as SD_TIMEOUT
#define SCSI_CMD_MAX_RETRIES                                                   \
  5 // normal drives shouldn't fail the command even once
#define SCSI_CAP_MAX_RETRIES 3
#define SCSI_BUF_SIZE                                                          \
  512 // originally defined in drivers/scsi/sd.h as SD_BUF_SIZE

// Old kernels used ambiguous constant:
