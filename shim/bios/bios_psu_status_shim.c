 ...
 * RS4021xsp and FS2500 to find the required symbol you can consult the mfgbios
 * output while booting the dev LKM
 */
...
static int HWMONGetPSUStatusByI2C_shim(void) { return 0; }

static int HWMONI2CGetPowerInfo_shim(void) { return 0; }

int I2CSmbusReadPowerStatus(void) { return 0; }
...
int register_bios_psu_status_shim(const struct hw_config *hw) {
  ...
  hw_config = hw;
  override_symbol_or_exit_int(HWMONGetPSUStatusByI2C_ovs,
                              "HWMONGetPSUStatusByI2C",
                              HWMONGetPSUStatusByI2C_shim);
  override_symbol_or_exit_int(RS4021xspI2CGetPowerInfo_ovs,
                              "RS4021xspI2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(RS4022xspI2CGetPowerInfo_ovs,
                              "RS4022xspI2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(RS4023xspI2CGetPowerInfo_ovs,
                              "RS4023xspI2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(RS4024xspI2CGetPowerInfo_ovs,
                              "RS4024xspI2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(FS3410I2CGetPowerInfo_ovs,
                              "FS3410I2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(FS6400I2CGetPowerInfo_ovs,
                              "FS6400I2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(FS6500I2CGetPowerInfo_ovs,
                              "FS6500I2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(HD6500I2CGetPowerInfo_ovs,
                              "HD6500I2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  override_symbol_or_exit_int(SA6500I2CGetPowerInfo_ovs,
                              "SA6500I2CGetPowerInfo",
                              HWMONI2CGetPowerInfo_shim);
  shim_reg_ok();
  return 0;
}
...
int unregister_bios_psu_status_shim(void) {
  ...
  if (unlikely(out != 0)) {
    pr_loc_err("Failed to restore RS4021xspI2CGetPowerInfo_ovs - error=%d",
               out);
    return out;
  }
  ...
  if (unlikely(out != 0)) {
    pr_loc_err("Failed to restore RS4022xspI2CGetPowerInfo_ovs - error=%d",
               out);
    return out;
  }
  ...
  if (unlikely(out != 0)) {
    pr_loc_err("Failed to restore RS4023xspI2CGetPowerInfo_ovs - error=%d",
               out);
    return out;
  }
  ...
  if (unlikely(out != 0)) {
    pr_loc_err("Failed to restore RS4024xspI2CGetPowerInfo_ovs - error=%d",
               out);
    return out;
  }
