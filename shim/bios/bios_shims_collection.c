 ...
 */
/*
 * Only purley, epyc7002 and epyc7003ntb not set CONFIG_SYNO_SATA_DISK_LED_CONTROL.
 * So only FS6400, HD6500, SA6400 now
 */
#if !defined(CONFIG_SYNO_EPYC7002) && !defined(CONFIG_SYNO_EPYC7003NTB) && !defined(CONFIG_SYNO_PURLEY)
